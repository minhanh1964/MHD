    ...
    <div className='container'>
      <Row>
        ...
        <Col span={8} className={style.BoxRight}>
          <Title level={2} className="text-white pt-1">Choosing Table</Title>
          <div className='pt-1'>
            <Title level={3} className="text-white text-left">Time and Date:</Title>
          ...
          <div className='pt-1'>
            <Title level={3} className="text-white text-left">Your Table: </Title>
          </div>
          <Row className='pt-1'>
            <Col span={19}>
              <Title level={3} className="text-white text-left">Number of people: </Title>
            </Col>
            <Col span={5}>
              <InputNumber
                min={1}
